...
<link href="https://cdn.datatables.net/v/bs5/jq-3.7.0/dt-2.3.2/r-3.0.5/sp-2.3.4/datatables.min.css" rel="stylesheet" integrity="sha384-nr2HNI1xgpaxEmc/HsSP/DR+eSV9xHkv8HVNcK9ydju/T9AP5e7WvMyfskuiENc7" crossorigin="anonymous">
<?php $this->stop() ?>
                                ...
                                <?php foreach ($tags as $tag): ?>
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" onclick="editTag(<?= $tag->id ?>, '<?= $this->e($tag->name) ?>')">
                ...
                <div class="card-body">
                    <form action="/shorten" method="POST" id="urlForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url"
                                class="form-control <?= isset($errors['longUrl']) ? 'is-invalid' : '' ?>"
                                id="longUrl"
                                name="longUrl"
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <button type="button" class="btn btn-outline-secondary" id="cancelBtn" style="display: none;" onclick="resetFormToCreateMode()">
            ...
            <div class="col-12 text-center">
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <?php if (!empty($selectedTags)): ?>
                            <h5 class="text-muted">No URLs found with selected tags</h5>
                            <p class="text-muted">Try adjusting your filter criteria or <a href="?" class="text-decoration-none">clear all filters</a>.</p>
                        <?php else: ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete this URL? This action
                        cannot be undone.</p>
                </div>
...
<script src="https://cdn.datatables.net/v/bs5/jq-3.7.0/dt-2.3.2/r-3.0.5/sp-2.3.4/datatables.min.js" integrity="sha384-wfP/If1m8lEtZeg/oZadbMmyCTfHKbV1zUtkIXBivvPKvAXOk6YN4ToytksJCuJz" crossorigin="anonymous"></script>
<script>
    ...
    function deleteTag(tagId, tagName) {
        ...
        document.getElementById('deleteTagName').innerHTML = tagName;
